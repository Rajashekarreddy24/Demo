...
function GridsterComponent_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngStyle", ctx_r1.gridRenderer.getGridColumnStyle(i_r1));
  }
}
function GridsterComponent_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("ngStyle", ctx_r1.gridRenderer.getGridRowStyle(i_r3));
  }
}
...
var _GridsterPreviewComponent = class _GridsterPreviewComponent {
...
_GridsterPreviewComponent.ɵfac = function GridsterPreviewComponent_Factory(t) {
  return new (t || _GridsterPreviewComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2));
};
_GridsterPreviewComponent.ɵcmp = ɵɵdefineComponent({
...
var GridsterPreviewComponent = _GridsterPreviewComponent;
(() => {
...
var _GridsterComponent = class _GridsterComponent {
...
_GridsterComponent.ɵfac = function GridsterComponent_Factory(t) {
  return new (t || _GridsterComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NgZone));
};
_GridsterComponent.ɵcmp = ɵɵdefineComponent({
...
var GridsterComponent = _GridsterComponent;
(() => {
...
var _GridsterItemComponent = class _GridsterItemComponent {
  get zIndex() {
...
_GridsterItemComponent.ɵfac = function GridsterItemComponent_Factory(t) {
  return new (t || _GridsterItemComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(GridsterComponent), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone));
};
_GridsterItemComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function GridsterItemComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ɵɵadvance();
      ɵɵconditional(1, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.s) && ctx.resize.resizeEnabled ? 1 : -1);
      ɵɵadvance();
      ɵɵconditional(2, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.e) && ctx.resize.resizeEnabled ? 2 : -1);
      ɵɵadvance();
      ɵɵconditional(3, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.n) && ctx.resize.resizeEnabled ? 3 : -1);
      ɵɵadvance();
      ɵɵconditional(4, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.w) && ctx.resize.resizeEnabled ? 4 : -1);
      ɵɵadvance();
      ɵɵconditional(5, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.se) && ctx.resize.resizeEnabled ? 5 : -1);
      ɵɵadvance();
      ɵɵconditional(6, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.ne) && ctx.resize.resizeEnabled ? 6 : -1);
      ɵɵadvance();
      ɵɵconditional(7, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.sw) && ctx.resize.resizeEnabled ? 7 : -1);
      ɵɵadvance();
      ɵɵconditional(8, (ctx.resize.resizableHandles == null ? null : ctx.resize.resizableHandles.nw) && ctx.resize.resizeEnabled ? 8 : -1);
    }
  },
...
var GridsterItemComponent = _GridsterItemComponent;
(() => {
...
var _GridsterModule = class _GridsterModule {
};
_GridsterModule.ɵfac = function GridsterModule_Factory(t) {
  return new (t || _GridsterModule)();
};
_GridsterModule.ɵmod = ɵɵdefineNgModule({
  type: _GridsterModule,
  imports: [GridsterComponent, GridsterItemComponent],
  exports: [GridsterComponent, GridsterItemComponent]
});
_GridsterModule.ɵinj = ɵɵdefineInjector({});
var GridsterModule = _GridsterModule;
(() => {
